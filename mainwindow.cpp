...
void MainWindow::createActions()
{
    ...
    setMusicDirectoryAction = new QAction(QIcon(":/music_folder.png"),
            ...
            tr("Open Music"), this);
#else
            tr("<p style=font:14px;color:green;>Click To <i>Refresh</i></P>"), this);
    setMusicDirectoryAction->setShortcut(tr("Ctrl+O"));
#endif
    playOrPauseAction = new QAction(playIcon,
#ifdef Q_WS_MAC
            tr("<p style=font:14px;color:green;>Play/Pause</p>"), this);
#else
            tr("<p style=font:14px;color:green;>Play/Pause (Spacebar)</P>"), this);
    ...
    stopAction = new QAction(QIcon(":/stop.png"),
            ...
            tr("Stop"), this);
#else
            tr("<p style=font:14px;color:green;>Stop (Ctrl+S)</p>"), this);
...
void MainWindow::setMusicDirectory()
{
    ...
    while (i.hasNext()) {
        ...
        if (!QFileInfo(filename).isFile() ||
            ...
            continue;
        addTrack(filename, &itemForArtist);
    }
        ...
        QHash<QString, TreeWidgetItem*> *itemForArtist)
{
    ...
    TreeWidgetItem *trackItem = new TreeWidgetItem(artistItem,
            QStringList() << track
